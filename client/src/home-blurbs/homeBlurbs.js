    ...
    return (
        <div className="blurb-container">
            ...
            <div className='blurb-text'>
                ...
                <Link to={props.link} onClick={() => {window.scroll(0, 0);}}>
...
//hardcoded placeholders for functionality
function CommunityBlurb(props) {
    return (
        <div className="blurb-container">
            <img src = {props.img} className="blurb-img" />
            <div className='blurb-text'>
...
function AllBlurbs(props) {
    return (
        <div>
            ...
            <RightBlurb img={photo_championship} icon={championship_icon} title={"Championship"} blurb={"For those who enjoy the company at Berkeley Legends and want to see more, we offer an optional paid Champions program granting bonus perks such as access to family system, Champion-exclusive socials, free tournament admission, custom discord emotes, and more!"} link={"/championship"} button={"BECOME A CHAMPION"} ></RightBlurb>
