...
function AllBlurbs(props) {
    return (
        <div>
            ...
            <LeftBlurb img={photo_events} icon={calendar_check_icon} title={"Events"} blurb={"From LAN parties to tournaments to board game nights, Berkeley Legends hosts a variety of events open to all Berkeley students! Keep an eye on our event calendar for upcoming events, and check out our photo albums for memories from the past ones."} button={"VIEW UPCOMING EVENTS"} ></LeftBlurb>
            ...
            <LeftBlurb img={photo_competitive} icon={team_icon} title={"Competitive Teams"} blurb={"We are proud to host Division 1 and 2 collegiate esports teams in League of Legends and Valorant, representing UC Berkeley at tournaments across the country. Find out more about our teams and make sure to cheer on the Golden Bears this season!"} button={"LEARN ABOUT COMPETITIVE"} ></LeftBlurb>
        </div>
    )
}
